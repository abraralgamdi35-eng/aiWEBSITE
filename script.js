...
function isImageRequest(message) {
    const keywords = [
        ...
        'make a picture', 'illustrate', 'artwork', 'visualize',
        'image of', 'picture of', 'draw me', 'show me',
        'anime', 'art', 'render', 'sketch', 'design',
        'generate a', 'create a', 'make me', 'generate',
    ...
    return `
        <div class="image-loading-overlay">
            ...
            <div class="loading-text">
                🎨 Generating image<span class="loading-dots"><span>.</span><span>.</span><span>.</span></span>
            </div>
    ...
    return `
        <div class="generated-image-container">
            ...
            <div class="image-label">
                ...
                <span style="color:var(--text-muted);font-size:10px;">• ${prompt.slice(0, 30)}${prompt.length > 30 ? '...' : ''}</span>
            </div>
        </div>
    `;
}
...
const UI = {
    ...
    showGenerating(prompt) {
        ...
        div.innerHTML = `
            ...
            <div class="msg-content">${createImageLoadingHTML(prompt)}</div>
        `;
        container.appendChild(div);
        container.scrollTop = container.scrollHeight;
        return div.id;
    ...
    showGeneratedImage(containerId, imageUrl, prompt) {
        ...
        if (container) {
            ...
            if (content) {
                content.innerHTML = createImageResultHTML(imageUrl, prompt);
            }
        }
    },
    ...
    _createNew() {
        ...
        container.innerHTML = `
            <div class="welcome-screen">
                ...
                <h1>NEXUS AI</h1>
                <p>I can answer questions AND generate images! 🎨</p>
                <div class="features">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    Chat.init();
    console.log('🚀 NEXUS AI - With Image Generation!');
